package com.bcube.userservice.config;
...
public class WebClientConfig {
     ...
     * hanging booking-service/payment-service would block the calling .block() call (and the
     * request thread using it, e.g. account deletion or the welcome-voucher grant) indefinitely
