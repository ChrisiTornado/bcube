...
# Private subnets: ECS tasks + RDS - never directly internet-reachable.
# Single NAT gateway (not one per AZ) - cheaper, acceptable for this traffic level; costs an
# extra ~$32/mo per additional NAT gateway if you want per-AZ redundancy later.
